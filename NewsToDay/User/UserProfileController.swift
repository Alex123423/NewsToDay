...
final class UserProfileController: UIViewController{
    ...
    lazy var termsButton: UIButton = {
        ...
        button.addTarget(self, action: #selector(termsButtonPressed), for: .touchUpInside)
        return button
    }()
    ...
    @objc func termsButtonPressed(_ sender: UIButton) {
        let termsConditions = TearmsConditionsController()
        present(termsConditions, animated: true, completion: nil)
        
    }
    
    @objc func signOutButtonPressed(_ sender: UIButton) {
        let signOut = OnboardingViewController()
    ...
    @objc func changeLanguagePressed(_ sender: UIButton) {
        ...
        present(language, animated: true, completion: nil)
    ...
    private func setConstraints() {
        NSLayoutConstraint.activate([
            ...
            termsButton.bottomAnchor.constraint(equalTo: view.safeAreaLayoutGuide.bottomAnchor, constant: -180),
            termsButton.widthAnchor.constraint(equalToConstant: 360),
